...
import { VerificationFrom } from 'features/pages/auth/verificationFrom';
        ...
        <Provider store={store}>
            <BrowserRouter>
                <Routes>
                    ...
                    <Route path="/verificationFrom" element={<VerificationFrom />} />
                    <Route path='/resetpassword' element={<Resolver}/>
