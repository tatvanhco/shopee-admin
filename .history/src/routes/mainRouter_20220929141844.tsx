...
import { AdminLayout, CatalogManager, CustomerManager, EmloyeeManager, InnerContent, InventoryManagement, ManageOrders, Statistical } from 'components/layout';
        ...
        <Route path="/" element={<PrivateRoute />}>
            <Route path="/" element={<InnerContent />}>
                ...
                <Route path="admin" element={<AdminLayout />}>
                    ...
                    <Route path="/admin/inventoryManagement" element={<ManageOrders />} />
                    <Route path="/admin/inventoryManagement" element={<InventoryManagement />} />
                    <Route path="/admin/inventoryManagement" element={<InventoryManagement />} />
                </Route>
            </Route>
