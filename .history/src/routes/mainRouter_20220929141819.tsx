...
import { AdminLayout, CatalogManager, CustomerManager, EmloyeeManager, InnerContent, InventoryManagement, Statistical } from 'components/layout';
        ...
        <Route path="/" element={<PrivateRoute />}>
            <Route path="/" element={<InnerContent />}>
                ...
                <Route path="admin" element={<AdminLayout />}>
                    ...
                    <Route path="/admin/statistical" element={<InventoryManagement />} />
                </Route>
            </Route>
        </Route>
