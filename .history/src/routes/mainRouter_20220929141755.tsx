...
import { AdminLayout, CatalogManager, CustomerManager, EmloyeeManager, InnerContent, Statistical } from 'components/layout';
        ...
        <Route path="/" element={<PrivateRoute />}>
            <Route path="/" element={<InnerContent />}>
                ...
                <Route path="admin" element={<AdminLayout />}>
                    ...
                    <Route path="/admin/statistical" element={<EmloyeeManager />} />
                    <Route path="/admin/statistical" element={<Statistical />} />
                </Route>
            </Route>
        </Route>
