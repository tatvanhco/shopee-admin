    ...
    return (
        <div className="SideBar">
            <div className="sideBar__items">
                ...
                <Link to="/inventoryManagement" className={location.pathname.includes('/inventory Management') ? 'sidebar_active' : ''}>
                    Inventory Management
                </Link>
                <Link to="/login" className={location.pathname.includes('/') ? 'sidebar_active' : ''}>
                    Login
                </Link>
