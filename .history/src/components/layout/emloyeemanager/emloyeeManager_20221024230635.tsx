    ...
    return (
        <div className="employee_table">
            <div className={clsx('flex', 'justify-between', 'mb-4', 'px-5')}>
                ...
                <div className={employee_btn}>
                    <Button className={styles.addEmployee_btn} onClick={handleOpenAddEmployee} variant="contained">
                        Thêm nhân viên
                    </Button>
                    <Modal
                    ...
                    >
                        <Box className={clsx(styles.add_Employee_modal)}>
                            ...
                            >
                                ...
                                <CloseIcon className={styles.close_icon} onClick={handleCloseAddEmployee} />
                            </div>
                            <div className={clsx(styles.add_Employee_modal_content, 'px-16', 'py-2')}>
                                <form method="POST">
