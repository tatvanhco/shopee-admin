    ...
    return (
        <div className={clsx(styles.feature, 'flex-2')}>
            ...
            <div className={clsx(styles.bottom, 'flex', 'flex-col', 'items-center', 'justify-center', 'gap-4')}>
                ...
                <div className={clsx(styles.summary, 'flex', 'items-center', 'justify-around')}>
                    <div className={clsx(styles.item)}>
                        <div className={clsx(styles.item_title)}>Mục tiêu</div>
                        <div className={clsx(styles.item_result, styles.positive, 'flex', 'items-center', 'mt-3')}>
                            <div className={clsx(styles.result_amount)}>5.000.000 VNĐ</div>
