...
export const rows = [
    createData(1, 'tất Vành cơ', 111, 'vanhco@gmail.com', 123456, 5900651515),
    ...
    createData(6, 'tất Vành cơ 5', 116, 'vanhco@gmail.com', 123456, 0900657515),
    createData(7, 'tất Vành cơ 6', 117, 'vanhco@gmail.com', 123456, 0900671515),
    createData(8, 'tất Vành cơ 7', 118, 'vanhco@gmail.com', 123456, 0900651515),
    createData(9, 'tất Vành cơ 8', 119, 'vanhco@gmail.com', 123456, 0900671515),
    createData(10, 'tất Vành cơ 9', 1110, 'vanhco@gmail.com', 123456, 0900685515),
    createData(11, 'tất Vành cơ 10', 1111, 'vanhco@gmail.com', 123456, 0980651515),
    createData(12, 'tất Vành cơ 11', 1112, 'vanhco@gmail.com', 123456, 0900551515),
];
