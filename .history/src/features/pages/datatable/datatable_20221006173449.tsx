    ...
    const rows = [
        {
            ...
            deleteBtn: <DeleteOutlineOutlinedIcon onClick={() => const [data, setData] = React.useState(rows)
                const handleDelete = () => {};} className={styles.deleteBtn} />,
        },
        {
            checkbox: <Checkbox />,
            stt: 2,
            ...
            deleteBtn: <DeleteOutlineOutlinedIcon onClick={handleDelete} className={styles.deleteBtn} />,
        },
    ];
