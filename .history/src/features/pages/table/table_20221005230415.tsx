        ...
        <div className={styles.tables}>
            <table className={clsx(styles.table, 'table-fixed', 'border', 'border-collapse', 'border-slate-300')}>
                ...
                <tbody>
                    {rows.map((row) => (
                        <tr key={row.stt}>
                            <td key={row.stt} className={clsx('border', 'border-slate-300', 'text-center', "px")}>
                                {row.stt}
                            </td>
                            <td className={clsx('border', 'border-slate-300', 'text-center', "px")}>{row.custmer}</td>
                            <td className={clsx('border', 'border-slate-300', 'text-center', "px")}>{row.productid}</td>
                            <td className={clsx('border', 'border-slate-300', 'text-center', "px")}>{row.productname}</td>
                            <td className={clsx('border', 'border-slate-300', 'text-center', "px")}>{row.productcost} VNĐ</td>
                            <td className={clsx('border', 'border-slate-300', 'text-center', "px")}>{row.paymentmode}</td>
                            <td className={clsx('border', 'border-slate-300', 'text-center', "px")}>{row.status}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
